...
//  ucwebswipe
//
//  Created by XuYang on 15/9/14.
//  Copyright (c) 2015年 dennisxu. All rights reserved.
//

#import "ViewController.h"
#import "BDLCustomerWebView.h"
@interface ViewController ()<BDLCustomerWebViewDelegate,UIWebViewDelegate,UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    grouponWebViewRect = CGRectMake(0, 0, widthOfScreen, heightOfScreen);
